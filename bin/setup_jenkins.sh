...
echo "var Set"
oc set env jenkins-agent-appdev --all GUID=8550
oc set env jenkins-agent-appdev --all REPO=https://github.com/Gabriela-Phillips/tasks.git
oc set env jenkins-agent-appdev --all CLUSTER=na311.openshift.opentlc.com
